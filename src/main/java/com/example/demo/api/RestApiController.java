...
public class RestApiController {
    ...
    public ResponseEntity<EmployeeEntity> insertData(@RequestBody EmployeeDto dto) {
        EmployeeEntity value = service.insertData(dto);
    ...
    public ResponseEntity<EmployeeEntity> getEmployeeCode(@PathVariable String code) {
        EmployeeEntity employee = repository.findByCode(code);
